...
},{"process":"node_modules/process/browser.js"}],"node_modules/algo-msgpack-with-bigint/dist/utils/utf8.js":[function(require,module,exports) {
var process = require("process");
"use strict";
...
exports.TEXT_ENCODING_AVAILABLE = typeof process !== "undefined" && undefined !== "never" && typeof TextEncoder !== "undefined" && typeof TextDecoder !== "undefined";
...
var sharedTextEncoder = exports.TEXT_ENCODING_AVAILABLE ? new TextEncoder() : undefined;
exports.TEXT_ENCODER_THRESHOLD = typeof process !== "undefined" && undefined !== "force" ? 200 : 0;
...
exports.TEXT_DECODER_THRESHOLD = typeof process !== "undefined" && undefined !== "force" ? 200 : 0;
...
},{"process":"node_modules/process/browser.js"}],"node_modules/algo-msgpack-with-bigint/dist/CachedKeyDecoder.js":[function(require,module,exports) {
"use strict";
...
var CachedKeyDecoder = /*#__PURE__*/function () {
  function CachedKeyDecoder() {
    var maxKeyLength = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_MAX_KEY_LENGTH;
    var maxLengthPerKey = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_MAX_LENGTH_PER_KEY;

    _classCallCheck(this, CachedKeyDecoder);
  ...
  _createClass(CachedKeyDecoder, [{
    key: "canBeCached",
    value: function canBeCached(byteLength) {
      return byteLength > 0 && byteLength <= this.maxKeyLength;
    }
  }, {
    key: "get",
    value: function get(bytes, inputOffset, byteLength) {
    ...
    key: "store",
    value: function store(bytes, value) {
    ...
    key: "decode",
    value: function decode(bytes, inputOffset, byteLength) {
      ...
      this.miss++;
      var value = utf8_1.utf8DecodeJs(bytes, inputOffset, byteLength); // Ensure to copy a slice of bytes because the byte may be NodeJS Buffer and Buffer#slice() returns a reference to its internal ArrayBuffer.
...
},{"./utils/utf8":"node_modules/algo-msgpack-with-bigint/dist/utils/utf8.js"}],"node_modules/@pipeline-ui-2/pipeline/index.js":[function(require,module,exports) {
var Buffer = require("buffer").Buffer;
"use strict";
...
function switchConnector(event) {
  _pipeline.default.pipeConnector = event.target.value;
  console.log(_pipeline.default.pipeConnector);
}

...
function connect() {
  Pipeline.connect(myAlgoWallet).then((data) => {
    ...
    document.getElementById("snoopy2").innerText = "Amount: " + (state.stateAmount || 0) + " " + state.assetName;
  });
}
...
document.getElementById("algopaybutton").onclick = setOpen;

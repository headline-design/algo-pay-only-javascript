  ...
  if (index !== 0) {
    ...
    fetch(url2)
      ...
      .then((data) => {
        ...
        Object.assign(state, { stateAmount: window.details.amount / parseInt(value) });
    ...
    Object.assign(state, { stateAmount: window.details.amount / 1000000 });
    document.getElementById("snoopy2").innerText = "" + (state.stateAmount) + " " + state.assetName;

  ...
  if (index !== 0) {
    ...
    fetch(url2)
      ...
      .then((data) => {
        ...
        if(window.details.input === true){amount = amount * parseInt(value)}
...
if (window.details.input !== false){
  document.getElementById("inputAmount").innerHTML = '<input id="amountInputter" type="number" value="0"/>'
